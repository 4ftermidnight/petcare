...
public class ClassErrorForAttributeTagProcessor extends AbstractAttributeTagProcessor{

	private static final String NOME_ATRIBUTO = "classerrorfor";
	private static final int PRECEDENCIA = 1000;
	
	public ClassErrorForAttributeTagProcessor(String dialectPrefix) {
